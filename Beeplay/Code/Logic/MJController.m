...
//            MJUser *user = [MJUser currentUser];
//            NSLog(@"%@", user.email);
//            NSAssert(user.birthday == nil, @"birthday is nil") ;
...
- (NSArray *)availableBeeps:(NSError **)error
{
    ...
    [subscriptionsQuery whereKey:@"status" containedIn:@[@(MJBeepSubscriptionStatusFeedbackDeclined), @(MJBeepSubscriptionStatusTimedOut)]];
